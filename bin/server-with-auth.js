...
<body>
    <div class="login-box">
        ...
        <form id="loginForm" method="POST" action="/api/auth/login">
            <input type="email" name="email" id="email" placeholder="邮箱地址" value="admin@ecommerce-ai-agents.org" required>
            <input type="password" name="password" id="password" placeholder="密码" value="Admin123!" required>
        ...
        if (pathname === '/health') {
            const healthData = {
                ...
                endpoints: {
                    ...
                    protected: ['/admin', '/products', '/api/products', '/api/orders', '/api/ai/chat']
                }
            };
...
<body>
    <div class="header">
        ...
        <div style="margin-top: 15px;">
            <a href="/admin" style="color: white; text-decoration: underline;">管理后台</a>
    ...
    <script>
        ...
        async function loadProducts() {
            try {
                ...
                document.getElementById('productsContainer').innerHTML = '<p style="color: red;">加载产品失败，请检查网络连接</p>';
            }
        }
